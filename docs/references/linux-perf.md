> **原始出處：** https://hackmd.io/@sysprog/linux-perf
> **擷取日期：** 2026-02-26
> **用途：** 課程教材 — 運用 Perf 分析程式效能並改善
> **涵蓋度：** 完整
> **省略內容：** 無
...
### 小結
本文從 Call Graph 的原理談起，接著再介紹記錄 Stack Trace 的注意事項與 Call Graph 的判讀方法。最後本文以一個實際的例子示範如何使用 Perf Events 分析與最佳化程式。
